...
var CountdownWc = function (_HTMLElement) {
     ...
     */
    function CountdownWc(self) {
        var _this, _ret;

        _classCallCheck(this, CountdownWc);

        self = (_this = _possibleConstructorReturn(this, (CountdownWc.__proto__ || Object.getPrototypeOf(CountdownWc)).call(this, self)), _this);
...
var CountdownWcNumber = function (_HTMLElement2) {
     ...
     */
    function CountdownWcNumber(self) {
        var _this3, _ret2;

        _classCallCheck(this, CountdownWcNumber);

        self = (_this3 = _possibleConstructorReturn(this, (CountdownWcNumber.__proto__ || Object.getPrototypeOf(CountdownWcNumber)).call(this, self)), _this3);
        self.current = null;
        self.next = null;
        ...
        return _ret2 = self, _possibleConstructorReturn(_this3, _ret2);
    }
    ...
    _createClass(CountdownWcNumber, [{
        ...
        value: function connectedCallback() {
            ...
            this.querySelector(".count .top.next").addEventListener("transitionend", function () {
                //Clean up after the animation has been completed
                _this4.$count.classList.add("changed");
                _this4.$count.classList.remove("changing");
        ...
        value: function attributeChangedCallback(name, oldValue, newValue) {
            ...
            if (oldValue === null) {
                ...
                setTimeout(function () {
                    _this6.$count.classList.add("changing");
                }, 20);
            }
        }
    }], [{
